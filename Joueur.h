...
void defausser(int nbADefausser, Carte c); // : méthode qui permet de défausser une carte


// accesseurs
int getMainWagon();
int getCouleur();
int getNbticketgagne();
map<Couleur_e,int> getMainCarte();
vector<Ticket*> getMainTicket();
void afficherMain(); // : affiche la main complète d’un joueur (ie. mainCarte, mainTicket, mainWagon)
